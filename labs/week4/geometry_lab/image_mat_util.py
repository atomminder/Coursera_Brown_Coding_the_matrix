...
mat2display(position,color)
# since mat2display() creates a temporary file and loads it in your default web browser, you have to pause your program because as soon as it finishes, 
# the temporary file is gone and the browser can't load it
